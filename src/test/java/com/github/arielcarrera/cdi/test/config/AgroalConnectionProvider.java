...
/**
 * ConnectionProvider based on Hibernate-agroal connectionProvider that expose metrics (for testing purpose)
 * ----
...
public class AgroalConnectionProvider implements ConnectionProvider, Configurable, Stoppable {
	...
	public void configure(Map props) throws HibernateException {
		...
		try {
			...
			TransactionIntegration txIntegration = new NarayanaTransactionIntegration(transactionManager, transactionSynchronizationRegistry, 
					"java:/testds", false);
