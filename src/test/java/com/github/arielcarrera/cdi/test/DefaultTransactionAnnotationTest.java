...
import com.github.arielcarrera.cdi.test.services.DefaultTransactionalTestService2;
...
public class DefaultTransactionAnnotationTest {
    ...
    @Inject
    protected DefaultTransactionalTestService2 service2;
...
//	}
    ...
    // TODO review it must to create a new transaction inside... but
    // @Transactional(TxType.REQUIRED) is into SpringData interface and it seems to
    // have no proxy
    @Test
