 ...
 *
 */
public class MyTransactionalInterceptorRequiresNew extends MyTransactionalInterceptorBase {

	private static final long serialVersionUID = -4021274469167378937L;

	public MyTransactionalInterceptorRequiresNew(BeanManager beanManager, TransactionManager transactionManager) {
