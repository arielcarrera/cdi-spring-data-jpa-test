 ...
 *
 */
public class MyTransactionalInterceptorSupports extends MyTransactionalInterceptorBase {
	private static final long serialVersionUID = 4806317578125179693L;

	public MyTransactionalInterceptorSupports(BeanManager beanManager, TransactionManager transactionManager) {
