 ...
 *
 */
public class CustomTransactionalInterceptorNever extends CustomTransactionalInterceptorBase {
	private static final long serialVersionUID = -5108362263547352763L;

	public CustomTransactionalInterceptorNever(BeanManager beanManager, TransactionManager transactionManager) {
