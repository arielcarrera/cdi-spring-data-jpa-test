 ...
 *
 */
public class MyTransactionalInterceptorMandatory extends MyTransactionalInterceptorBase {
	private static final long serialVersionUID = -7373677226175879796L;

	public MyTransactionalInterceptorMandatory(BeanManager beanManager, TransactionManager transactionManager) {
