 ...
 *
 */
public class CustomTransactionalInterceptorRequired extends CustomTransactionalInterceptorBase {
	private static final long serialVersionUID = -1589716376766222605L;

	public CustomTransactionalInterceptorRequired(BeanManager beanManager, TransactionManager transactionManager) {
