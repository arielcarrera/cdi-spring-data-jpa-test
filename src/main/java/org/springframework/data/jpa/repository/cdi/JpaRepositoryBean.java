 ...
 */
public class JpaRepositoryBean<T> extends CdiRepositoryBean<T> {
	 ...
	 */
	public JpaRepositoryBean(BeanManager beanManager, Bean<EntityManager> entityManagerBean, Set<Annotation> qualifiers,
